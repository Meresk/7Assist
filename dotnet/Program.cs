...
// Load env variables
int SERVER_PORT = config.GetValue<int>("SERVER_PORT"); ;
string LIVEKIT_API_KEY = config.GetValue<string>("LIVEKIT_API_KEY");
string LIVEKIT_API_SECRET = config.GetValue<string>("LIVEKIT_API_SECRET");
// Enable CORS support
